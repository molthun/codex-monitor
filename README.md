...
The widget is intentionally configured as part of the desktop, not as an always-on-top overlay. Hardware sensors come from a .NET 10 bridge using LibreHardwareMonitor, and Rainmeter reads a flat text file generated by that bridge.
